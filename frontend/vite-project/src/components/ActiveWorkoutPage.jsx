...
export default function ActiveWorkoutPage ({ setActivePage, setShowButtons, currentTemplate, setCurrentTemplate, currentWorkoutExercises, setCurrentWorkoutExercises, activeWorkoutData, setActiveWorkoutData, workoutData, setWorkoutData }) {
  ...
  function shiftExerciseUp () {
    console.log('this would move the exercise up')
    // do it by index?
    // search through workoutdata to find index of selected exercise to move
    // move exericse up or down by one
    // setworkout to new array order
  }

  function shiftExerciseDown () {
    console.log('this would move the exercise down')
  }
                ...
                <div className='text-lg'> {exercise.name}
                  <span>
                    <details className='dropdown'>
                      <summary className='ml-2 btn mr-12 font-bold'>...</summary>
                    ...
                    <svg className='inline nowrap' onClick={shiftExerciseUp} width='50px' height='50px' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
                    ...
                    <svg className='inline nowrap' onClick={shiftExerciseDown} width='50px' height='50px' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
