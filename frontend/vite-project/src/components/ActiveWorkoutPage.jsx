              ...
              <div className='text-left mt-3 font-bold' key={index}>
                <span className='flex justify-between'>
                  ...
                  <div className='flex'>
                    ...
                    <div className='flex'>
                      <svg className='inline nowrap' onClick={() => shiftExerciseUp(workoutData, index)} width='55px' height='55px' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
                      ...
                      <svg className='inline nowrap' onClick={() => shiftExerciseDown(workoutData, index)} width='50px' height='50px' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
